...
var _default = exports.default = panelData;
...
var _default = exports.default = linkData;
...
function makePanel(_ref2 /* what data does the panel need? */) {
  ...
  */
  ...
  panelButtons.addEventListener('click', function (event) {
...
var panelElements = _panelData.default.map(function (panelObj) {
...
_linkData.default.forEach(function (linkObj) {
  var linkElement = linkMaker(linkObj);
